...
from ..forms import FoodonatorSignUpForm
...
class FoodonatorSignUpView(CreateView):
    ...
    template_name = 'registration/res_signup_form.html'
    ...
    def form_valid(self, form):
        ...
        return redirect('teachers:orders') #donators:pickups????? 
...
class PickupListView(ListView):
    ...
    template_name = 'classroom/teachers/orders.html'
...
class PickupCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        pickup.save()
        messages.success(self.request, 'The pickup was created with success! Go ahead and add some questions now.')
        return redirect('teachers:quiz_change', pickup.pk)
...
class PickupDeleteView(DeleteView):
    ...
    success_url = reverse_lazy('teachers:orders')

    def delete(self, request, *args, **kwargs):
        pickup = self.get_object()
        messages.success(request, 'The pickup %s was deleted with success!' % pickup.cuisine)
